...
Source0  : https://files.pythonhosted.org/packages/65/51/fbffab4071afa789e515421e5749146beff65b3d371ff30d861e85587306/dnspython-2.5.0.tar.gz
Summary  : DNS toolkit
...
%prep
%setup -q -n dnspython-2.5.0
cd %{_builddir}/dnspython-2.5.0
pushd ..
cp -a dnspython-2.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705865251
