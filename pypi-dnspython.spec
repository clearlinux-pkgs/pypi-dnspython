...
Source0  : https://files.pythonhosted.org/packages/b5/4a/263763cb2ba3816dd94b08ad3a33d5fdae34ecb856678773cc40a3605829/dnspython-2.7.0.tar.gz
Summary  : DNS toolkit
...
%prep
%setup -q -n dnspython-2.7.0
cd %{_builddir}/dnspython-2.7.0
pushd ..
cp -a dnspython-2.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728427322
